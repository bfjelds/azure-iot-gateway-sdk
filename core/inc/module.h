...
extern "C"
{
	...
	*/
	typedef struct MODULE_TAG
	{
		...
		/** @brief Pointer to module implementation #MODULE_DATA_TYPED. */
	...
	*/
	...
	/** @brief	Structure used to represent C style idea of a module.  Contains
	*			Hamdle & FxnPtrs.
	*/
	...
	/** @brief	Structure used to represent C++ idea of a module.  Contains
	*			an interface ptr.
	*/
